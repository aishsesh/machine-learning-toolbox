...
%   validation set (pval) and the ground truth (yval) using the F1 score.
% the pval parameter is the probability density function of the multivariate gaussian distribution.
